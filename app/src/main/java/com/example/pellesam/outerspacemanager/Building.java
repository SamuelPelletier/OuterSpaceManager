...
public class Building {
    ...
    public Integer getGasCost(){
        Integer result = this.getAmountOfEffectLevel0() + this.getAmountOfEffectByLevel() * this.level;
        return result;
    }

    public Integer getMineralCost(){
        Integer result = this.getMineralCostLevel0() + this.getMineralCostByLevel() * this.level;
        return result;
    }

    public Integer getTimeToBuild(){
        Integer result = this.timeToBuildLevel0 + this.timeToBuildByLevel * this.level;
        return result;
    }

    public Integer getAmountEffect(){
        Integer result = this.amountOfEffectLevel0 + this.amountOfEffectByLevel * this.level;
        return result;
    }
